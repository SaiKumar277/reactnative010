...
export default function Templatedslr ({ route, navigation }){
    ...
    return (
        ...
        <SafeAreaView style={{backgroundColor:'#ccffff'}}>
        ...
        <View style={styles.bg}>
             <ScrollView style={styles.container}>
                ...
                <View
                    ...
                    <Text style={styles.mostsim} >Most similar product available in amazon :</Text>
